...
public class Main {
    ...
    public static void threePlayerPhases(Scanner input){
        ...
        List<Integer> playerNameLengthList = new ArrayList<>();
        ...
        playerNameLengthList.add(player1.length());
        playerNameLengthList.add(player2.length());
        playerNameLengthList.add(player3.length());
        ...
        do{
            try{           
                ...
                printPlayerAvailableCards(player1, player1CardsQueue,playerNameLengthList);
                printPlayerAvailableCards(player2, player2CardsQueue,playerNameLengthList);
                printPlayerAvailableCards(player3, player3CardsQueue,playerNameLengthList);
                System.out.println();
                ...
                if (userInput.toUpperCase().equals("S")){
                    ...
                    for (int i = 1; i < 4; i++)
                        threePlayerRound(input, i, player1, player2, player3, cardsList, player1CardsQueue, player2CardsQueue, player3CardsQueue, playerGameDetails, playerNameLengthList);
                    System.exit(0);
                }
                else{
                    player1CardsQueue.clear(); player2CardsQueue.clear(); player3CardsQueue.clear();
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static void threePlayerRound(Scanner input, int num, String player1, String player2, String player3, List<Card> cardsList, Queue<Card> player1CardsQueue, Queue<Card> player2CardsQueue, Queue<Card> player3CardsQueue, List<Game> playerGameDetails, List<Integer> playerNameLengthList){
        Player p = new Player();
        ...
        printPlayerPlayedCards(player1, player1Points, eachRoundPlayer1CardsList, playerGameDetails, playerPointsList, playerNameLengthList);
        printPlayerPlayedCards(player2, player2Points, eachRoundPlayer2CardsList, playerGameDetails, playerPointsList, playerNameLengthList);
        printPlayerPlayedCards(player3, player3Points, eachRoundPlayer3CardsList, playerGameDetails, playerPointsList, playerNameLengthList);
        System.out.println();
        pressEnterToContinue(input);
        printPlayerScore(playerGameDetails, playerPointsList, playerNameLengthList);
        System.out.println();
        System.out.println("[Available Cards]");
        printPlayerAvailableCards(player1, player1CardsQueue,playerNameLengthList);
        printPlayerAvailableCards(player2, player2CardsQueue,playerNameLengthList);
        ...
        if (num == 3){
            ...
            twoPlayerPhases(input, firstWinner, secondWinner,  firstWinnerScore, secondWinnerScore, cardsList, playerNameLengthList, player1CardsQueue, player2CardsQueue);
        }
        else
            pressEnterToNextRound(input);
    }
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static void printPlayerPlayedCards(String player, int playerPoints, List<Card> playerCardsList, List<Game> playerGameDetails, List<Integer> playerPointsList, List<Integer> playerNameLengthList){
        Player p = new Player();
        String strPlayerNameSize = Integer.toString(maxPlayerNameLength(playerNameLengthList));
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static void printPlayerAvailableCards(String player, Queue<Card> playerCardsQueue, List<Integer> playerNameLengthList){
        Player p = new Player();
        String strPlayerNameSize = Integer.toString(maxPlayerNameLength(playerNameLengthList));
        System.out.printf("%" + strPlayerNameSize + "s : ", player);
    ...
    public static String playerPhasesWinner(int count, List<Game> playerGameDetails){
        String winner = "";
        TreeSet<Integer> playerScoreSet = new TreeSet<Integer>();
        for (Game g: playerGameDetails){
            playerScoreSet.add(g.getPlayerScore());
        }
        List<Integer> playerScoreList = new ArrayList<>(playerScoreSet);
        for (Game g: playerGameDetails){
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static void printPlayerScore(List<Game> playerGameDetails, List<Integer> playerPointsList, List<Integer> playerNameLengthList){
        System.out.println();
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static void twoPlayerPhases(Scanner input, String player1, String player2, int player1Score, int player2Score, List<Card> cardsList, List<Integer> playerNameLengthList, Queue<Card> player1CardsQueue, Queue<Card> player2CardsQueue){
        DeckOfCards d = new DeckOfCards();
        Player p = new Player();
        player1CardsQueue.clear(); player2CardsQueue.clear(); playerNameLengthList.clear();
        List<Game> playerGameDetails = new ArrayList<>();
        playerGameDetails.add(new Game(player1, player1Score));
        playerGameDetails.add(new Game(player2, player2Score));
        playerNameLengthList.add(player1.length()); playerNameLengthList.add(player2.length());
        System.out.println();
        System.out.println("------------------");
        ...
        do{
            try{           
                ...
                if (userInput.toUpperCase().equals("S")){
                    ...
                    for (int i = 1; i < 6; i++)
                        twoPlayerRound(input, i, player1, player2, cardsList, player1CardsQueue, player2CardsQueue, playerGameDetails, playerNameLengthList);
                    System.exit(0);
                }
                else{
                    player1CardsQueue.clear(); player2CardsQueue.clear(); 
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static void twoPlayerRound(Scanner input, int num, String player1, String player2, List<Card> cardsList, Queue<Card> player1CardsQueue, Queue<Card> player2CardsQueue, List<Game> playerGameDetails, List<Integer> playerNameLengthList){
        Player p = new Player();
        List<Integer> playerPointsList = new ArrayList<>();
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static int maxPlayerNameLength(List<Integer> playerNameLengthList){
        return Collections.max(playerNameLengthList);
    }
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
